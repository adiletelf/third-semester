...
private:
	...
	int bit2byte(int bits) const;
	int byte2bit(int bytes) const;
...
public:
	...
	BoolRank& operator= (bool value) { value_ = value; bv_.update(value_, index_); return *this; }
	BoolRank& operator= (int value) { value_ = bool(value); bv_.update(value_, index_); return *this; }
	BoolRank& operator= (char ch) { value_ = (ch != '0') ? true : false; bv_.update(value_, index_); return *this; }

	// See the definition in bvector.cpp
